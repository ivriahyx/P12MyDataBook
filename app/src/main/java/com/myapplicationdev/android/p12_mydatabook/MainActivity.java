...
//    private String[] drawerItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataList dataListBio = new DataList("Bio");
        DataList dataListVacc = new DataList("Vaccination");
        DataList dataListAnni = new DataList("Anniversary");
        DataList dataListAboutUs = new DataList("About Us");

        ab = getSupportActionBar();
        al.add(dataListBio);
        al.add(dataListVacc);
        al.add(dataListAnni);
        al.add(dataListAboutUs);

        aa = new DataAdapter(getApplicationContext(), R.layout.row_list, al);
